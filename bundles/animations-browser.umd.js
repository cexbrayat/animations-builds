...
var AnimationAstBuilderVisitor = /** @class */ (function () {
    ...
    function (metadata, context) {
        ...
        var styleAst;
        /** @type {?} */
        var styleMetadata = metadata.styles ? metadata.styles : _angular_animations.style({});
...
var TransitionAnimationEngine = /** @class */ (function () {
    ...
    function (cleanupFns, microtaskId) {
        ...
        /** @type {?} */
        var allLeaveQueriedNodes = cloakAndComputeStyles(postStylesMap, this.driver, leaveNodesWithoutAnimations, allPostStyleElements, _angular_animations.AUTO_STYLE);
