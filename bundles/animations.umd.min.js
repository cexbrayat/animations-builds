 ...
 * License: MIT
 */
!function(global,factory){"object"==typeof exports&&"undefined"!=typeof module?factory(exports):"function"==typeof define&&define.amd?define("@angular/animations",["exports"],factory):factory((global.ng=global.ng||{},global.ng.animations={}))}(this,function(exports){"use strict";
/**
 * @license Angular v7.0.0-beta.4-51c0d9cae9
 * (c) 2010-2018 Google, Inc. https://angular.io/
 * License: MIT
 */var AnimationBuilder=function(){return function(){}}(),AnimationFactory=function(){return function(){}}();
/**
 * @license
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */exports.AnimationBuilder=AnimationBuilder,exports.AnimationFactory=AnimationFactory,exports.AUTO_STYLE="*",exports.animate=function(timings,styles){return void 0===styles&&(styles=null),{type:4,styles:styles,timings:timings}},exports.animateChild=function(options){return void 0===options&&(options=null),{type:9,options:options}},exports.animation=function(steps,options){return void 0===options&&(options=null),{type:8,animation:steps,options:options}},exports.group=function(steps,options){return void 0===options&&(options=null),{type:3,steps:steps,options:options}},exports.keyframes=function(steps){return{type:5,steps:steps}},exports.query=function(selector,animation,options){return void 0===options&&(options=null),{type:11,selector:selector,animation:animation,options:options}},exports.sequence=function(steps,options){return void 0===options&&(options=null),{type:2,steps:steps,options:options}},exports.stagger=function(timings,animation){return{type:12,timings:timings,animation:animation}},exports.state=function(name,styles,options){return{type:0,name:name,styles:styles,options:options}},exports.style=function(tokens){return{type:6,styles:tokens,offset:null}},exports.transition=function(stateChangeExpr,steps,options){return void 0===options&&(options=null),{type:1,expr:stateChangeExpr,animation:steps,options:options}},exports.trigger=function(name,definitions){return{type:7,name:name,definitions:definitions,options:{}}},exports.useAnimation=function(animation,options){return void 0===options&&(options=null),{type:10,animation:animation,options:options}},exports.NoopAnimationPlayer=NoopAnimationPlayer,exports.ɵAnimationGroupPlayer=AnimationGroupPlayer,exports.ɵPRE_STYLE="!",Object.defineProperty(exports,"__esModule",{value:!0})});